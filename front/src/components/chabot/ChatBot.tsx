...
const ChatBot = () => {
  const { messages, input, setInput, sendMessage, resetChat, chatStarted, startChat } = useChat();
    ...
    return (
      <div className="w-full max-w-3xl mx-auto h-[70vh] bg-white dark:bg-gray-900 rounded-xl shadow-md flex flex-col overflow-hidden border border-gray-200 dark:border-gray-800">
        ...
        <form
          ...
          className="px-6 py-3 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 flex gap-2"
        >
          <input
            type="text"
          ...
          <button
            type="submit"
            className="px-4 py-2 rounded-md bg-brand-500 text-white hover:bg-brand-600 transition text-base"
          >
            Envoyer
          </button>
        </form>
